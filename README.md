...
A role-based academic platform that streamlines campus operations. It enables Admins to manage users, courses, and schedules; Teachers to share resources, track attendance, and manage grades; and Students to monitor events and access assignments.

[View Project](https://mpji-campus-sync.vercel.app/)

---

### BlogVerse

A blogging platform that allows users to create, read, publish, and comment on posts. Includes user authentication, category-based filtering, and intuitive navigation.

[View Project](https://mpji-blogverse.vercel.app/)

---

### JobHunt

A modern job portal connecting job seekers with recruiters. Features include role-based authentication, dynamic job search, resume uploads, and application tracking.

[View Project](https://mpji-jobhunt.vercel.app/)
